...
<div class="container" style="margin-top:45px;">
    <div class="row">
        <div class="large-12 columns">
            <div style="margin-bottom:45px;"><h2>Upcoming Courses</h2></div>
        	@foreach($courses as $course)
        		<article class="panel box">
        			...
        			<p><strong>When: </strong>{!! $course->date !!}</p>
        			<p><strong>Time: </strong>{!! $course->time !!}</p>
        			<p><strong>Prerequisites: </strong>{!! $course->prerequisites !!}</p>
        			<p><strong>Tuition: </strong>${!! $course->price !!}</p>
                    <p>
                        <em>Note: We'll be accepting credit cards soon. In the mean time, you can 
                        secure your spot with paypal.</em>
                    </p>
                    <!-- <a class="button" href="enroll">Sign Me Up!</a> -->
